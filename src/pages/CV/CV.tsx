...
const CV: FC = () => (
  <>
    ...
    <div className='cv'>
      <article>
        <span className="cv__info__name">{info.name}</span><br/>
        <span className="cv__info__born">b, {info.born}</span><br/>
      ...
      <article>
        <h3>Experience</h3>
        {
          experience.map(({ company, dates, description, job, responsibilities, team }) => (
            <div key={`${company}-${team}`}>
              <Date dates={dates} /><br/>
              <span className="cv__title">{`${job}, ${company}${team ? `: ${team}` : ''}`}</span><br/>
              <p>{description}</p>
        ...
        <h3>Education</h3>
        {
          education.map(({ course, dates, institution, university, grade }) => (
            <div key={`${university}-${institution}-${course}`}>
              <Date dates={dates} /><br/>
              <span className="cv__title">{course}</span><br/>
